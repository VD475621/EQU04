...
import controleurs.CtrlRapReser;
...
public class FrmRapReser extends JFrame {
	/**
	 * 
	 */
		...
		btnGenerer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(!Tbox_date2.getText().isEmpty() && !Tbox_date1.getText().isEmpty()){
					CtrlRapReser.apercu("RapReser.jrxml", Tbox_date1.getText(), Tbox_date2.getText());
					instance.dispose();
				}
			}
		});
