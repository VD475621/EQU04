...
public class Frm_Arrive extends Frm_Base {
	...
	public Frm_Arrive() {
		...
		TB_NumCham.addMouseListener(new MouseAdapter(){
			public void mouseClicked(MouseEvent e)
			{
				if(e.getClickCount() >= 2)
				{
					System.out.println("DoubleClicked");
					crt_arrive.ChamDoubleClicked();
				}
			}
		});
		...
		TB_NoReserv.addMouseListener(new MouseAdapter(){
			public void mouseClicked(MouseEvent e)
			{
				...
				{
					System.out.println("DoubleClicked");
					crt_arrive.ReservDoubleClicked();
				}
			}
		});
		...
		TBL_Reserv.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent me) {
				if(me.getClickCount() >= 2)
				{
					crt_arrive.TableDoubleClicked(me.getPoint());
				}
			}
		});
